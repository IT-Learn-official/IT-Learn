...
- `tel`: input voor telefoonnummer.
- `url`: URL-input met validatie.
- `search`: zoekveld, vaak met extra styling zoals een zoekicoon.
...
- `color`: kleurkiezer.
- `range`: slider voor een numeriek bereik.

---

Ga nu naar het practice-tabblad en begin te bouwen!
