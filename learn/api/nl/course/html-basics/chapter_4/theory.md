...
De `<head>` bevat metadata: informatie over de pagina die browsers en zoekmachines gebruiken. Je ziet die niet als “inhoud” op de pagina, maar ze doet wel veel.
...
Denk aan de head als het label op een pakketje dat je besteld hebt. Het verandert de inhoud niet, maar het helpt om het juist te behandelen en te “begrijpen”.
