...
HTML staat voor **HyperText Markup Language.** Zie een webpagina als een huis: HTML is het skelet en de kamers die bepalen waar dingen komen: de muren, deuren en ramen. Het vertelt de browser welke stukken content er zijn en hoe ze in elkaar genest zijn.
...
HTML vs CSS vs JavaScript: HTML geeft structuur, CSS geeft presentatie (styles) en JavaScript geeft gedrag en interactie.
