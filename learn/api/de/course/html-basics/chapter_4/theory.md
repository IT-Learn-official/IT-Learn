...
Der `<head>` enthält Metadaten – Informationen über die Seite, die Browser und Suchmaschinen nutzen. Er erscheint nicht als sichtbarer Inhalt, ist aber sehr wichtig.
...
Denk an den head wie an das Label auf einem Paket. Es ändert nicht den Inhalt, aber es hilft dabei, das Paket richtig zu behandeln und zu „verstehen“.
