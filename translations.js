...
const translations = {
    en: {
        ...
        teamCoOwnerSuperman: "Hello! I am super_man2775, the co-owner of IT Learn! I am very happy to be part of this project, and I still have many fun and useful things on my to-do list. I hope to make IT Learn really big someday (and preferably sooner rather than later 😀).",
        coOwner: "Co-owner",
    ...
    nl: {
        ...
        teamCoOwnerSuperman: 'Hallo! Ik ben super_man2775, de co-owner van IT Learn! Ik ben heel blij om deel uit te maken van dit project, en heb dan ook nog veel leuke en handige zaken op mijn to do lijstje staan. Ik hoop om IT Learn ooit heel groot te maken (en liever vandaag dan morgen 😀)',
    ...
    de: {
        ...
        coOwner: "Mitbesitzer",
        teamCoOwnerSuperman: 'Hallo! Ich bin super_man2775, Mitinhaber von IT Learn! Ich freue mich sehr, Teil dieses Projekts zu sein, und habe noch viele spannende und nützliche Dinge auf meiner To-do-Liste. Ich hoffe, IT Learn eines Tages richtig groß zu machen (und am liebsten schon bald 😀).',
    ...
    fr: {
        ...
        teamCoOwnerSuperman: "Salut ! Je suis super_man2775, co-fondateur d'IT Learn ! Je suis ravi de participer à ce projet et j'ai encore plein de choses intéressantes et utiles à faire. J'espère qu'IT Learn deviendra un jour un projet d'envergure (et de préférence bientôt 😀).",
