...
const translations = {
    en: {
        ...
        teamSuperman: "Hello! I'm super_man2775, co-owner of IT Learn! I'm very happy to be part of this project, and I also have lots of fun and useful things on my to-do list. I hope to make IT Learn very big one day (and preferably sooner rather than later 😀)",
        coOwner: "Co-owner",
        ...
        teamViviodezio: "Hi, I'm Vivio and I'm a moderator for IT Learn, so I mainly keep the Discord safe and engaging. I'm currently learning how to code with IT Learn, and hope to see you in the Discord server too!",
        ...
        teamMatteohls: "I'm Matteohls, an Assistant Discord Manager for IT Learn. I'm always here to support the community, answer questions, and help keep everything running smoothly. I focus on creating a welcoming, organized, and positive environment where everyone feels comfortable and engaged.",
        ...
        roleManager: 'Manager',
        roleAssistantManager: 'Assistant Manager',
    ...
    nl: {
        ...
        teamSuperman: 'Hallo! Ik ben super_man2775, de co-owner van IT Learn! Ik ben heel blij om deel uit te maken van dit project, en heb dan ook nog veel leuke en handige zaken op mijn to do lijstje staan. Ik hoop om IT Learn ooit heel groot te maken (en liever vandaag dan morgen 😀)',
        ...
        teamViviodezio: "Hoi, ik ben Vivio en ik ben moderator voor IT Learn, dus ik zorg er vooral voor dat de Discord veilig en boeiend blijft. Ik leer momenteel coderen met IT Learn, en ik hoop je ook te zien in de Discord-server!",
        ...
        teamMatteohls: 'Ik ben Matteohls, een Assistant Discord Manager voor IT Learn. Ik ben er altijd om de community te ondersteunen, vragen te beantwoorden en alles vlot te laten verlopen. Ik focus op een warme, georganiseerde en positieve omgeving waarin iedereen zich comfortabel en betrokken voelt.',
    ...
    de: {
        ...
        coOwner: "Mitbesitzer",
        teamSuperman: 'Hallo! Ich bin super_man2775, Mitinhaber von IT Learn! Ich freue mich sehr, Teil dieses Projekts zu sein, und habe viele lustige und nützliche Dinge auf meiner To‑Do‑Liste. Ich hoffe, IT Learn eines Tages sehr groß zu machen (und lieber heute als morgen 😀)',
        ...
        teamViviodezio: 'Hi, ich bin Vivio und ich bin Moderator bei IT Learn, also halte ich vor allem den Discord sicher und spannend. Ich lerne gerade mit IT Learn zu programmieren und hoffe, dich auch im Discord-Server zu sehen!',
        ...
        teamMatteohls: 'Ich bin Matteohls, Assistant Discord Manager bei IT Learn. Ich bin immer da, um die Community zu unterstutzen, Fragen zu beantworten und dafur zu sorgen, dass alles reibungslos lauft. Mein Fokus liegt auf einer einladenden, organisierten und positiven Umgebung, in der sich alle wohl und eingebunden fuhlen.',
    ...
    fr: {
        ...
        teamSuperman: 'Salut ! Je suis super_man2775, co-propriétaire d\'IT Learn ! Je suis très heureux de faire partie de ce projet, et j\'ai aussi plein de choses amusantes et utiles sur ma to-do list. J\'espère faire grandir IT Learn un jour (de préférence aujourd\'hui plutôt que demain 😀)',
        ...
        teamViviodezio: 'Salut ! Je suis Vivio et je suis modérateur chez IT Learn, donc je veille surtout à garder le Discord sûr et vivant. J\'apprends actuellement à coder avec IT Learn, et j\'espère te voir aussi sur le serveur Discord !',
        ...
        teamMatteohls: 'Je suis Matteohls, Assistant Discord Manager chez IT Learn. Je suis toujours la pour soutenir la communaute, repondre aux questions et aider a garder tout fluide. Je me concentre sur un environnement accueillant, organise et positif ou chacun se sent a l\'aise et implique.',
